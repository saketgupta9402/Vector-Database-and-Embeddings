...
def get_conversational_chain():
    ...
    Try to provide **a new perspective** if asked the same question multiple times.
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs = st.file_uploader("Upload Your PDF files and then Click on 'Submit and Process' button", accept_multiple_files=True)
